...
interface AuthCoreRepository {
    suspend fun signIn(login: String, password: String, update: Boolean): SignInResultAuth
    suspend fun signUp(login: String, password: String, state: UserState, withSignIn: Boolean): SignUpResultAuth
}
